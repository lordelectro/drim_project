window.onload = function () {
  ...
  document.querySelector('.placebet').addEventListener('click', complex)
...
function complex () {
  swal.withForm({
    ...
    closeOnConfirm: true,
    formFields: [
      { id: 'name', placeholder: 'Custmer Name' },
      { id: 'nickname', placeholder: 'Phone Number' },
      { id: 'betamount', placeholder: 'Bet Amount in SSP' },

      { name: 'Resusumed win', value: 'possible Win', type:'text',type:'Disabled' },
